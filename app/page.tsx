...
//             <div className="flex gap-2">
//               <button onClick={() => setIsModalOpen(false)} className="flex-1 bg-gray-100 py-2 rounded-xl">إغلاق</button>
//               <button onClick={handleUpdatePassword} disabled={isUpdating} className="flex-1 bg-[#D4AF37] py-2 rounded-xl font-bold">تحديث</button>
//             </div>
//             <p className="text-[10px] text-center text-gray-400 mt-4">حقوق نظام تحديث كلمة المرور محفوظة لشركة الدولار توب © 2026</p>
//           </div>
//         </div>
...
//       setModalMessage("خطأ: " + error.message);
//     } else {
//       setModalMessage("تم التحديث بنجاح!");
//       setTimeout(() => { setIsModalOpen(false); setNewPassword(""); }, 2000);
//     }
//     setIsUpdating(false);
//   };
...
//             <h3 className="font-black mb-4">تغيير كلمة المرور</h3>
//             <input type="password" value={newPassword} onChange={(e) => setNewPassword(e.target.value)} placeholder="كلمة المرور الجديدة" className="w-full p-3 border rounded-xl mb-4" />
//             {modalMessage && <p className="text-sm font-bold mb-4">{modalMessage}</p>}
//             <div className="flex gap-2">
//               <button onClick={() => setIsModalOpen(false)} className="flex-1 bg-gray-100 py-2 rounded-xl">إغلاق</button>
//               <button onClick={handleUpdatePassword} disabled={isUpdating} className="flex-1 bg-[#D4AF37] py-2 rounded-xl font-bold">تحديث</button>
//             </div>
...
//     e.preventDefault();
//     setLoading(true);
//     setErrorMessage(""); // تصفير الخطأ عند كل محاولة جديدة
...
//                 className="w-full p-4 border border-gray-300 rounded-xl text-lg text-right focus:outline-none focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37] transition-all bg-white text-gray-900"
//                 dir="rtl"
//                 required
//               />
//               <input
...
//                 type="submit"
//                 disabled={loading}
//                 className="w-full bg-[#D4AF37] hover:bg-[#C29D2F] text-black py-4 rounded-xl text-xl font-black transition-all transform active:scale-95 shadow-md mt-2 disabled:opacity-50"
//               >
//                 {loading ? "جاري الدخول..." : "تسجيل الدخول"}
//               </button>
...
//                 className="w-full text-gray-400 hover:text-[#D4AF37] text-sm font-bold transition-colors mt-4 flex items-center justify-center gap-2"
//               >
//                 <span className="underline">دخول المسؤول</span>
//               </button>
//             </form>
